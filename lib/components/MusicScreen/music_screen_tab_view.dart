...
class _MusicScreenTabViewState extends State<MusicScreenTabView>
    ...
    if (widget.tabContentType == TabContentType.tracks) {
      ...
      offlineItems = await _isarDownloader.getAllCollections(
        ...
        viewFilter: widget.tabContentType == TabContentType.albums
            ...
            : null,
        childViewFilter:
            (widget.tabContentType != TabContentType.albums &&
  ...
  void initState() {
    ...
    _musicScreenRefreshStreamSubscription = musicScreenRefreshStream.stream
        .listen((_) {
          _refresh();
        });
    _downloadsRefreshStreamSubscription = _isarDownloader.offlineDeletesStream
        .listen((event) {
          _refresh();
        });
    super.initState();
  ...
  void scrollToLetter(String? clickedLetter) async {
    ...
    bool reversed =
        FinampSettingsHelper.finampSettings.tabSortOrder[widget
            .tabContentType] ==
